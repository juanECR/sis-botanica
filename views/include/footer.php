	...
	<script src="../botanical/js/jquery-3.4.1.min.js"></script>
	<!-- include bootstrap popper JavaScript -->
	<script src="../botanical/js/popper.min.js"></script>
	<!-- include bootstrap JavaScript -->
	<script src="../botanical/js/bootstrap.min.js"></script>
	<!-- include custom JavaScript -->
	<script src="../botanical/js/jqueryCustome.js"></script>
</body>
</html>