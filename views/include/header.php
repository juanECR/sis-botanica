...
<head>
	...
	<link rel="stylesheet" href="../botanical/css/bootstrap.css">
	<!-- include the site fontawesome stylesheet -->
	<link rel="stylesheet" href="../botanical/css/fontawesome.css">
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="../botanical/style.css">
	<!-- include theme plugins setting stylesheet -->
	<link rel="stylesheet" href="../botanical/css/plugins.css">
	<!-- include theme color setting stylesheet -->
	<link rel="stylesheet" href="../botanical/css/color.css">
	<!-- include theme responsive setting stylesheet -->
	<link rel="stylesheet" href="../botanical/css/responsive.css">
</head>
<body>
	<!-- pageWrapper -->
	<div id="pageWrapper">
